...
const MQTT_PROTO_STATE_CHANGED = "server:proto-state-changed"
...
type ConnectionEventsSet struct {
	...
	ProtoStateChanged string `json:"protoStateChanged"`
}
...
func (e *ConnectionEvents) GetConnectionEventsSet(connectionId uint) ConnectionEventsSet {
	return ConnectionEventsSet{
		...
		ProtoStateChanged: MQTT_PROTO_STATE_CHANGED + ":" + fmt.Sprint(connectionId),
	}
}
