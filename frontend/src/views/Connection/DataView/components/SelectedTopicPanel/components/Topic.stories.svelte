<script module lang="ts">
  ...
  import Component from "./Topic.svelte";
  ...
  const storyId = "Views/Connection/DataView/SelectedTopicPanel/Topic";
  const props: string[] = ["topic"];
  const storyArgs = getStoryArgs(storyId, componentName, props);

  const { Story } = defineMeta({
    title: "Views/Connection/DataView/SelectedTopicPanel/Topic",
    component: Component,
    tags: ["autodocs"],
