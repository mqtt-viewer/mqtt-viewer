<script module lang="ts">
  ...
  import Component from "./MqttDataPanel.svelte";
  ...
  const props: string[] = ["connection","selectedTopicStore","pinnedTopicsStore","width","copyTopicPath","exportTopicMessages","onClearRetained","onClearRetainedBelow"];
  const storyArgs = getStoryArgs(storyId, componentName, props);

  const { Story } = defineMeta({
    title: "Views/Connection/DataView/MqttDataPanel",
    component: Component,
    tags: ["autodocs"],
