...
export const mockSparkplugNodeRow = {
  kind: "node" as const,
  key: "EnergyCo/substation-7",
  id: "EnergyCo/substation-7",
  index: 1,
  levelCount: 1,
  isExpanded: true,
...
export const mockSparkplugMetricRow = {
  ...
  key: "EnergyCo/substation-7",
  id: "m\u0000EnergyCo/substation-7\u0000Volts/L1",
  index: 5,
  levelCount: 2,
  isExpanded: false,
  node: mockSubstation7,
...
const componentDefaults: Record<string, Record<string, unknown>> = {
  ...
  SparkplugPanel: {
    ...
    onSelectMetric: noop,
    onCopyValue: noop,
    onClearWarnings: noop,
    onClearFilter: noop,
  },
  SparkplugRow: {
    row: mockSparkplugNodeRow,
    nowMs: now,
    domId: "sparkplug-row-story",
    isSelected: false,
    isActive: false,
    treeFocused: false,
    isHighlighted: false,
