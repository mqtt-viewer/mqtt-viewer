<script module lang="ts">
  ...
  import Component from "./CopyToClipboard.svelte";
  import StoryRender from "@/stories/StoryRender.svelte";
  import { getStoryArgTypes, getStoryArgs } from "@/stories/fixtures";

  const componentName = "CopyToClipboard";
  const storyId = "Primitives/CopyToClipboard";
  const props: string[] = ["text","size","tooltipText"];
