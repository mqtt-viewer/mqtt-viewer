<script module lang="ts">
  ...
  import Component from "./CodeEditor.svelte";
  import StoryRender from "@/stories/StoryRender.svelte";
  import { getStoryArgTypes, getStoryArgs } from "@/stories/fixtures";

  const componentName = "CodeEditor";
  const storyId = "Components/CodeEditor";
  const props: string[] = ["text","format","readOnly","setEditorText"];
